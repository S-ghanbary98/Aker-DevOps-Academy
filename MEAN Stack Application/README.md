...
- Node.js (Javascript Runtime Env) accepts request and display result to user
...
![node image](img/node_version.png)
...
![port](img/port.png)
![run](img/running.png)
![application](img/application1.png)