...
![alt text](img/port5000_result.png)
...
![alt text](img/successful_database_connection.png)
...
![alt text](img/npm_run_dev2.png)

![alt text](img/final_application.png)